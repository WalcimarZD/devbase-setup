...
def blueprint(
    ctx: typer.Context,
    description: Annotated[Optional[str], typer.Argument(help="Project description (e.g., 'FastAPI with Redis')")] = None,
) -> None:
    """
    ...
    # Interactive Prompt for Description (Micro-UX Improvement)
    if description is None:
        console.print("[bold]🏗️  Blueprint Generator[/bold]")
        console.print("[dim]Describe what you want to build, and AI will generate the file structure.[/dim]")
