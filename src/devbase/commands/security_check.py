...
# Performance & Correctness: Avoid meaningless scans and false positives in dependency/VCS/cache dirs
IGNORED_DIRS = {
    "node_modules",
    ".git",
    "__pycache__",
...
def find_unprotected_secrets(root: Path) -> List[Tuple[Path, str]]:
    ...
    if gitignore_path.exists():
        try:
            ...
            console.print(
                f"[yellow]Warning:[/yellow] Could not read .gitignore at {gitignore_path}: {exc}"
            )
